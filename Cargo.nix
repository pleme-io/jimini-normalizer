...
rec {
  ...
  workspaceMembers = {
    "jimini-normalizer" = rec {
      packageId = "jimini-normalizer";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bollard" = rec {
        ...
        version = "0.18.1";
        edition = "2021";
        sha256 = "0c2chnmijrbqr5y4chdwpnycl6v5q6ndajlrfnflasmgc09cmk4p";
        authors = [
        ...
        resolvedDefaultFeatures = [ "default" "home" "http" "hyper-named-pipe" "hyper-rustls" "hyper-util" "hyperlocal" "pipe" "rustls" "rustls-native-certs" "rustls-pemfile" "rustls-pki-types" "ssl" "ssl_providerless" ];
      };
      "bollard-stubs" = rec {
        crateName = "bollard-stubs";
        version = "1.47.1-rc.27.3.1";
        edition = "2021";
        sha256 = "1nnhrp9x28ygiq0aka0akj935zvb8cq4ngbhf9a7mrxnvpxrq5rz";
      ...
      "docker_credential" = rec {
        crateName = "docker_credential";
        version = "1.3.2";
        edition = "2018";
        sha256 = "1s0djikbndjxap7jhiy08lz4d40mfngb768a8pbzljjvlk5xz28x";
        authors = [
      ...
      "jimini-normalizer" = rec {
        crateName = "jimini-normalizer";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
            name = "config-admin";
            path = "src/bin/config_admin.rs";
            requiredFeatures = [ ];
          }
          {
            name = "db-bootstrap";
            path = "src/bin/db_bootstrap.rs";
            requiredFeatures = [ ];
          }
          {
        ...
        dependencies = [
          ...
          }
          {
            name = "sea-orm";
            packageId = "sea-orm";
            features = [ "runtime-tokio-rustls" "sqlx-postgres" "macros" ];
          }
          {
            name = "serde";
            packageId = "serde";
      ...
      "parse-display" = rec {
        ...
        version = "0.9.1";
        edition = "2021";
        sha256 = "12jkqych9y44v1dqrhwjax4lylnqhsncd0hjj53293n9cli1qjli";
        libName = "parse_display";
        authors = [
          "frozenlib"
        ];
        dependencies = [
      ...
      "parse-display-derive" = rec {
        ...
        version = "0.9.1";
        edition = "2021";
        sha256 = "10aj6h3hf2maf1zayg0p2m2ag9vriqrncwlivw9gsklp9h581rra";
        procMacro = true;
        libName = "parse_display_derive";
        authors = [
          "frozenlib"
        ];
        dependencies = [
      ...
      "pleme-observability" = rec {
        ...
        version = "0.3.0";
        edition = "2021";
        sha256 = "0nf9nls8kb0wpf710857x5v0fzp5gczixxqbjxgd9l7jigwcv8a3";
      ...
      "testcontainers" = rec {
        ...
        version = "0.23.3";
        edition = "2021";
        sha256 = "0x4wccf50v4fp6hn2zqmihbbpqmii3cb0gmjb8mgq45v74gz192r";
        authors = [
          "Thomas Eizinger"
        ...
        features = {
          ...
          "serde-java-properties" = [ "dep:serde-java-properties" ];
      ...
      "testcontainers-modules" = rec {
        ...
        version = "0.11.6";
        edition = "2021";
        sha256 = "01y7ws2a3w2l7kqlv8v6hqzc5hs3cvmdnmkc5hx4qhjqix7fshsd";
        ...
        resolvedDefaultFeatures = [ "default" "nats" "postgres" ];
      };
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "async-compression" "compression-gzip" "cors" "default" "follow-redirect" "futures-core" "futures-util" "iri-string" "tokio" "tokio-util" "tower" "trace" "tracing" ];
      };
      "tower-layer" = rec {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "winerror" ];
      };
